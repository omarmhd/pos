    ...
    <div class="col-lg-9">
        ...
        <div class="help-section" id="sec-inventory">
            ...
            <div class="section-body">
                ...
                <div class="alert-tip">
                    <i class="bi bi-mouse"></i> <strong>بطاقة المنتج 360°:</strong> من قائمة المنتجات، انقر مزدوجًا على أي صف لفتح بطاقة الصنف الكاملة — تعرض في تبويبات منظّمة: أرصدة المستودعات، كل المشتريات، كل المبيعات، وحركات المخزون، إضافةً إلى سجل تغيّر التكلفة (AVCO) ورسم الوارد/الصادر الشهري.
                </div>
        ...
        <div class="help-section" id="sec-purchase-orders">
            ...
            <div class="section-body">
                ...
                <div class="subsection-title">طباعة أمر الشراء وتصديره PDF</div>
                <p>من صفحة عرض أمر الشراء (أو من زر PDF في قائمة الأوامر) يمكنك:</p>
                <ul>
                    <li><strong>طباعة / عرض</strong> — يفتح أمر الشراء كملف PDF بتنسيق رسمي (ترويسة الشركة، بيانات المورد، الأصناف، الشروط، وحقول التوقيع) في تبويب جديد جاهز للطباعة المباشرة أو الإرسال للمورد.</li>
                    <li><strong>تنزيل PDF</strong> — يحفظ نفس الملف على جهازك باسم <code>purchase-order-PO-رقم.pdf</code>.</li>
                </ul>
                <div class="alert-tip mt-2">
                    قالب الطباعة يدعم العربية (RTL) بالكامل، ويعرض ترويسة المتجر وبيانات الاتصال من إعدادات النظام، مع حقلَي توقيع للمُعتمِد والمورد.
                </div>
            </div>
        </div>
        ...
        <div class="help-section" id="sec-accounting">
            ...
            <div class="section-body">
                ...
                <div class="alert-tip">
                    <i class="bi bi-search"></i> <strong>حقل الحساب = مربّع بحث واختيار مجمّع:</strong> في شاشة القيد اليدوي يمكنك البحث واختيار من أربع مجموعات:
                    <strong>الحسابات الرئيسية، العملاء، الموردون، الموظفون</strong>. عند اختيار عميل/مورّد يُرحَّل السطر تلقائيًا على حساب المراقبة (ذمم العملاء/الموردين) ويُربط الطرف؛ وعند اختيار موظف تحدّد حسابه (سلف/رواتب مستحقة). يظهر الطرف المرتبط في صفحة القيد، ويتيح تتبّع حركة كل جهة (أستاذ مساعد فوق حساب المراقبة).
                </div>
        ...
        <div class="help-section" id="sec-cash-shift">
            ...
            <div class="section-body">
                ...
                <div class="workflow-step"><div class="step-num">3</div><div class="step-body">
                    ...
                    <div class="step-desc">إذا كان هناك فرق، يُسوّى الصندوق للمبلغ الفعلي ويُثبَّت الفرق: العجز كمصروف (6530)، والفائض كإيراد (4160).</div>
                </div></div>
                <div class="gl-example mt-3">
                    <table class="w-100"><tr>
                        <td class="gl-debit">نقص (عجز): مدين — عجز نقدي ورديات (6530)</td><td>المبلغ</td>
                    </tr><tr>
                        <td class="gl-credit">دائن — صندوق الفرع (1000.XX)</td><td>المبلغ</td>
                    </tr></table>
                </div>
                <div class="workflow-step mt-3"><div class="step-num">4</div><div class="step-body">
                    <div class="step-title">تسوية الفرق (معالجة العجز/الفائض)</div>
                    <div class="step-desc">
                        من صفحة الوردية، زر «تسوية الفرق» يُعيد تصنيف الفرق <strong>دون المساس بالصندوق</strong> (الصندوق سُوِّي فعلًا عند الإقفال). الخيارات:
                        <ul class="mb-0">
                            <li><strong>العجز → تحميل على الكاشير:</strong> مدين سلف الموظف (1250) / دائن العجز (6530) — يصبح ذمة على الكاشير تُحصَّل نقدًا أو تُخصم من الراتب.</li>
                            <li><strong>العجز → اعتماد كمصروف:</strong> يبقى في حساب العجز (دون قيد) — موافقة المدير.</li>
                            <li><strong>الفائض → أمانة عميل:</strong> مدين الفائض (4160) / دائن أمانات العملاء (2050) — التزام يُردّ عند المطالبة.</li>
                            <li><strong>الفائض → اعتماد كإيراد:</strong> يبقى في حساب الفائض (دون قيد).</li>
                        </ul>
                    </div>
                </div></div>
                <div class="alert-tip mt-2">التسوية تتم مرة واحدة لكل وردية، وتُسجَّل (النوع، المنفِّذ، القيد). المدير يستطيع عرض ورديات جميع الكاشيرين؛ الكاشير يرى وردياته فقط.</div>
            </div>
        </div>
        ...
        <div class="help-section" id="sec-eosb">
            ...
            <div class="section-body">
                <p>قاعدة الاحتساب <strong>قابلة للتخصيص بالكامل</strong> من: الإعدادات ← «قاعدة مكافأة نهاية الخدمة». تُعرّف <strong>شرائح</strong> بعدد أيام الأجر المستحقة لكل سنة خدمة حسب مدة الخدمة (مثال خليجي: 21 يومًا/سنة لأول 5 سنوات، ثم 30 يومًا/سنة فأكثر)، كما تختار أساس الراتب (الأساسي فقط أو الأساسي + البدلات) ومقسوم الأجر اليومي (افتراضي 30).</p>
                <p class="subsection-title">طريقة الحساب (المطلوب التراكمي — IAS 19)</p>
                <p>الأجر اليومي = الراتب الأساس ÷ أيام الشهر. المطلوب المستحق حتى نهاية الشهر = (مجموع أيام الاستحقاق عبر الشرائح) × الأجر اليومي. <strong>المخصص الشهري = المطلوب المستحق − ما رُحِّل سابقًا للموظف</strong> — فيُعالَج تلقائيًا تجاوز الموظف لشريحة أعلى وتغيّر راتبه.</p>
                <div class="gl-example">
                    <table class="w-100"><tr>
                ...
                <div class="alert-tip mt-2">يمكن <strong>تجاوز القاعدة لكل موظف</strong> من نموذج بيانات الموظف (شرائح وأساس راتب خاصّان به)؛ إن تُركت فارغة يتّبع الموظف الإعداد العام. يتوفّر تقرير «معاينة» يعرض تفصيل كل موظف قبل الترحيل، والترحيل idempotent — لا يُعيد الترحيل لنفس الشهر.</div>
            </div>
        </div>
