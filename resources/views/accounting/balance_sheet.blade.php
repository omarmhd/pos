...
<div class="container-fluid">
    ...
    <div class="alert alert-danger d-flex align-items-center gap-2">
        ...
        <strong>تحذير: الميزانية غير متوازنة</strong> — الفرق: {{ number_format($difference, 2) }} {{ $currency }}
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end pe-3 fw-semibold">{{ number_format($row['amount'], 2) }} {{ $currency }}</td>
                            </tr>
                            @empty
                            ...
                            <tr class="table-primary fw-bold">
                                ...
                                <td class="text-end pe-3">{{ number_format($totalCurrentAssets, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            ...
                            <tr class="table-info fw-bold">
                                ...
                                <td class="text-end pe-3">{{ number_format($totalFixedAssets, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr class="fw-bold fs-6 bg-primary text-white border-top border-3">
                                ...
                                <td class="text-end pe-3 py-3">{{ number_format($totalAssets, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="table-danger fw-bold">
                                ...
                                <td class="text-end pe-3">{{ number_format($totalCurrentLiabilities, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            ...
                            <tr class="table-secondary fw-bold">
                                ...
                                <td class="text-end pe-3">{{ number_format($totalLongTermLiabilities, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr class="fw-bold bg-danger bg-opacity-10 border-top border-2">
                                ...
                                <td class="text-end pe-3 py-2 text-danger">{{ number_format($totalLiabilities, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            ...
                            <tr class="{{ $netIncome >= 0 ? 'text-success' : 'text-danger' }}">
                                ...
                                <td class="text-end pe-3 fw-semibold">{{ number_format($netIncome, 2) }} {{ $currency }}</td>
                            </tr>

                            <tr class="table-success fw-bold">
                                <td class="ps-3">إجمالي حقوق الملكية</td>
                                <td class="text-end pe-3">{{ number_format($totalEquity, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr class="fw-bold fs-6 bg-danger text-white border-top border-3">
                                ...
                                <td class="text-end pe-3 py-3">{{ number_format($totalLiabAndEquity, 2) }} {{ $currency }}</td>
                            </tr>
                        </tbody>
            ...
            <div class="row text-center g-2">
                <div class="col-md-4">
                    <div class="p-2 border rounded">
                        <div class="fw-bold text-primary fs-5">{{ number_format($totalAssets, 2) }} {{ $currency }}</div>
                        <small class="text-muted">إجمالي الأصول</small>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-2 border rounded">
                        <div class="fw-bold text-danger fs-5">{{ number_format($totalLiabilities, 2) }} {{ $currency }}</div>
                        <small class="text-muted">إجمالي الالتزامات</small>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-2 border rounded">
                        <div class="fw-bold text-success fs-5">{{ number_format($totalEquity, 2) }} {{ $currency }}</div>
